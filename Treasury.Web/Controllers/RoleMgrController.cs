...
namespace Treasury.Web.Controllers
{
    ...
    public class RoleMgrController : BaseController
    {
        ...
        **/
        ...
        [HttpPost]
        public JsonResult changeCodeRole(string ROLE_AUTH_TYPE)
        {
            return Json(new CodeRoleDao().selectCodeRole(ROLE_AUTH_TYPE));
        }

        [HttpPost]
        public JsonResult changeCodeUser(string ROLE_ID)
        {
            return Json(new CodeUserDao().selectCodeUser(ROLE_ID));
        }
    }
