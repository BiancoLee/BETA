...
namespace Treasury.WebControllers
{
    ...
    public class AuthRptController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            //20190418 201904160117-00 Bianco 讀config RptMemo
            string rptMemo = System.Configuration.ConfigurationManager.AppSettings.Get("RptMemo");
            ViewBag.RptMemo = rptMemo;
            return View();
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Print(String cRptType, string memoTxt)
        {

            if ("userRole".Equals(cRptType))
                return printUserRole(memoTxt);
            else if("equMaintain".Equals(cRptType))              //20190418 201904160117-00 Bianco 新增金庫設備管理維護報表
                return printEquMaintain(memoTxt);
            else
        ...
        private ActionResult printRoleAuth()
        {
            ...
            else
            {
                ...
                string guid = "功能角色報表";                   //20190418 201904160117-00 Bianco 
                try
                {
                    string htmlText = "";
                    ...
                    return Json(new { success = true, guid = guid, fileName = "角色功能報表" });
        ...
        /// </summary>
        /// <returns></returns>
        private ActionResult printUserRole(string memo)
        {
            CodeUserDao codeUserDao = new CodeUserDao();
            ...
            else
            {
                ...
                try
                {
                    ...
                    htmlText = genRptUserRole(rptData, memo);
                    ...
                    return Json(new { success = true, guid = guid, fileName = "使用者角色報表" });
        ...
        /// </summary>
        /// <returns></returns>
        //20190418 201904160117-00 Bianco 新增金庫設備管理維護報表
        private ActionResult printEquMaintain(string memo)
        {
            CodeUserDao codeUserDao = new CodeUserDao();
            List<UserMgrModel> rptData = codeUserDao.qryUserRole();
            ...
            else
            {
                ...
                try
                {
                    ...
                    htmlText = genRptEquMaintain(rptData, memo);
                    ...
                    return Json(new { success = true, guid = guid, fileName = "金庫設備管理維護報表" });
        ...
        /// <returns></returns>
        //20190418 201904160117-00 Bianco 新增金庫設備管理維護報表
        private String genRptEquMaintain(List<UserMgrModel> rptData, string memo)
        {
            int totCnt = 0;
            ...
            //查出要列印的單位LIST
            List<UserMgrModel> depList = rptData.GroupBy(o => new { o.cWorkUnitCode }).OrderBy(x => x.Key.cWorkUnitCode)
            ...
            foreach (UserMgrModel pUserMgrModel in pDepList)
            {
                ...
                if (totCnt == 1)
                    //strTable = strTable + "<table border='0' width='100%' style='font-size:16px;'>";
                    titleTemp = "<table border='0' width='100%' style='font-size:16px;'>";
                else
                    //strTable = strTable + "<table border='0' width='100%' style='font-size:16px;page-break-before:always;'>";
                    titleTemp = "<table border='0' width='100%' style='font-size:16px;page-break-before:always;'>";
                ...
                //strTable += genRptHeader("equMaintain", dptCd, dptName, "");
                ...
                foreach (UserMgrModel authRptModel in depList.Where(x => x.upDptCd == pUserMgrModel.upDptCd))
                {
                    ...
                    foreach (UserMgrModel authUser in userList)
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(strRoleE.Replace("<br/>", ""))) //20190418 201904160117-00 Bianco 只顯示有項目者
                        {


                            formTemp += "<br/>";
                            formTemp = formTemp + "<table border='0' width='100%' style='font-size:12px;'>";
                            formTemp = formTemp + "<tr>";
                            formTemp = formTemp + "<td align='left'>" + "<span style='font-weight:bold;font-size:16px; '>單位：</span>" + StringUtil.toString(authRptModel.cWorkUnitCode)
                                + StringUtil.toString(authRptModel.cWorkUnitDesc) + "</td>";
                            formTemp = formTemp + "<td align='left'>" + "<span style='font-weight:bold;font-size:16px; '>使用者帳號：</span>" + StringUtil.toString(authUser.cUserID) + "</td>";          //20190418 201904160117-00 Bianco 修改成使用者帳號
                            formTemp = formTemp + "<td align='left'>" + "<span style='font-weight:bold;font-size:16px; '>中文姓名：</span>" + StringUtil.toString(roleList[0].cUserName) + "</td>";

                            formTemp = formTemp + "</tr>";
                            formTemp = formTemp + "</table>";

                            formTemp = formTemp + "<table align='center' cellpadding='5' cellspacing='0' width='100%'  style='font-size:12px;border-top:#000000 1px solid;border-left:#000000 1px solid'>";

                            formTemp = formTemp + "<tr>";
                            formTemp = formTemp + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center' width='10%'>角色群組</td>";
                            formTemp = formTemp + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'  width='20%'>金庫設備管理維護</td>";
                            formTemp = formTemp + "</tr>";

                            formTemp = formTemp + "<tr>";
                            formTemp = formTemp + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'>角色名稱</td>";
                            formTemp = formTemp + "<td style='border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'>" + strRoleE + "</td>";
                            ...
                            //strTable = strTable + "<td align='left'>" + "<span style='font-weight:bold;font-size:16px; '>使用者帳號：</span>" + StringUtil.toString(authUser.cUserID) + "</td>";          //20190418 201904160117-00 Bianco 修改成使用者帳號
                ...
                {
                    strTable = strTable + titleTemp;
                    strTable += genRptHeader("equMaintain", dptCd, dptName, "");
                    strTable = strTable + formTemp;
                    //表尾
                    strTable += genRptFooter();
                }
                //表尾
        ...
        /// <param name="rptData"></param>
        /// <returns></returns>
        private String genRptUserRole(List<UserMgrModel> rptData, string memo)
        {
            ...
            foreach (UserMgrModel pUserMgrModel in pDepList)
            {
                ...
                if (totCnt == 1)
                    //strTable = strTable + "<table border='0' width='100%' style='font-size:16px;'>";
                    titleTemp = titleTemp + "<table border='0' width='100%' style='font-size:16px;'>";
                else
                    //strTable = strTable + "<table border='0' width='100%' style='font-size:16px;page-break-before:always;'>";
                    titleTemp = titleTemp + "<table border='0' width='100%' style='font-size:16px;page-break-before:always;'>";
                ...
                foreach (UserMgrModel authRptModel in depList.Where(x => x.upDptCd == pUserMgrModel.upDptCd))
                {
                    ...
                    foreach (UserMgrModel authUser in userList)
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(strRoleF.Replace("<br/>", "")) || !string.IsNullOrWhiteSpace(strRoleI.Replace("<br/>", "")) || !string.IsNullOrWhiteSpace(strRoleA.Replace("<br/>", ""))) //20190418 201904160117-00 Bianco 只顯示有項目者
                        {
                            formTemp += "<br/>";
                            formTemp = formTemp + "<table border='0' width='100%' style='font-size:12px;'>";
                            formTemp = formTemp + "<tr>";
                            ...
                            formTemp = formTemp + "<tr>";
                            formTemp = formTemp + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center' width='10%'>角色群組</td>";
                            formTemp = formTemp + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'  width='20%'>授權功能</td>";
                            //strTable = strTable + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'  width='20%'>金庫設備權限</td>";   //20190418 201904160117-00 Bianco 移除金庫設備權限
                            formTemp = formTemp + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'  width='20%' >存取項目權限</td>";
                            formTemp = formTemp + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'>表單申請權限</td>";
                            formTemp = formTemp + "</tr>";

                            formTemp = formTemp + "<tr>";
                            formTemp = formTemp + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'>角色名稱</td>";
                            formTemp = formTemp + "<td style='border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'>" + strRoleF + "</td>";
                            //strTable = strTable + "<td style='border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'>" + strRoleE + "</td>";                                           //20190418 201904160117-00 Bianco 移除金庫設備權限
                            formTemp = formTemp + "<td style='border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'>" + strRoleI + "</td>";
                            formTemp = formTemp + "<td style='border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'>" + strRoleA + "</td>";
                            ...
                            ////20190418 201904160117-00 Bianco 移除備註欄位
                            ////strTable = strTable + "<tr>";
                            ////strTable = strTable + "<td style='font-weight:bold;font-size:14px;border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'>備註</td>";
                            ////strTable = strTable + "<td colspan='4' style='border-bottom:#000000 1px solid;border-right:#000000 1px solid;' align='center'></td>";
                            ////strTable = strTable + "</tr>";
                ...
                if (formTemp.Length > 0)
                {
                    ...
                    //20190418 201904160117-00 Bianco 加入表尾備註
                    strTable = strTable + "<br/>";
                    strTable = strTable + "<p>備註: </p>";
                    strTable = strTable + "<br/>";
                    strTable = strTable + "<p>" + memo + "</p>";
                }
                //表尾
                //strTable += genRptFooter();
            }
        ...
        private String genRptHeader(string rptType, string pDetCd, string pDetName, string roleAuthType)
        {
            ...
            else if ("equMaintain".Equals(rptType))
            {
                strTable = strTable + "<td colspan='2' align='center'><span style='font-weight:bold;font-size:20px; '>" + "金庫管理系統-金庫設備管理維護報表" + "</span></td>";
                strTable = strTable + "</tr>";
                strTable = strTable + "<tr>";
                strTable = strTable + "<td  colspan='2' align='center'>" + "<br/> <span style='font-weight:bold;font-size:18px; '>單位：</span>" + pDetCd + pDetName + "</td>";
            ...
            strTable = strTable + "<td  align='right'>" + "<br/> 製表日期：" + DateUtil.formatDateTimeDbToSc(DateTime.Now.ToString("yyyyMMdd"), "DT") + "</td>";                   //20190418 201904160117-00 Bianco 改製表日期
            strTable = strTable + "</tr>";

            if (!"userRole".Equals(rptType) && !"equMaintain".Equals(rptType))
            {
                strTable = strTable + "<tr>";
                switch (roleAuthType) {
                    case "F":
        ...
        public FileContentResult downloadRpt(String id, string name)
        {
            ...
            return File(fileBytes, "application/pdf", name + ".pdf");        //20190418 201904160117-00 Bianco 
        }
    }
}