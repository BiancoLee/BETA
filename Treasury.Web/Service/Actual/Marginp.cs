    ...
    public class Marginp : Common, IMarginp
    {
                ...
                else
                {
                    ...
                    result.AddRange(db.ITEM_DEP_RECEIVED.AsNoTracking()
                        ...
                        .Select((x) => new CDCMarginpViewModel()
                        {
                            ...
                            vPledge_Item_No_AFT = x.PLEDGE_ITEM_NO_AFT,
                            vEffective_Date_B = TypeTransfer.dateTimeNToString(x.EFFECTIVE_DATE_B),
                            vEffective_Date_B_AFT =
                            x.EFFECTIVE_DATE_B_AFT == new DateTime(1, 1, 1) ? "NULL" :
                            TypeTransfer.dateTimeNToString(x.EFFECTIVE_DATE_B_AFT),
                            vEffective_Date_E = TypeTransfer.dateTimeNToString(x.EFFECTIVE_DATE_E),
                            vEffective_Date_E_AFT =
                            x.EFFECTIVE_DATE_E_AFT == new DateTime(1, 1, 1) ? "NULL" :
                            TypeTransfer.dateTimeNToString(x.EFFECTIVE_DATE_E_AFT),
                            vDescription = x.DESCRIPTION,
                            vDescription_AFT = x.DESCRIPTION_AFT,
                            vMemo = x.MEMO,
                            vMemo_AFT = x.MEMO_AFT,
                ...
                foreach (CDCMarginpViewModel model in saveData)
                {
                    ...
                    if (_Marginp != null && !changFlag)
                    {
                        ...
                        if (!changFlag)
                        {
                            ...
                            _Marginp.EFFECTIVE_DATE_B_AFT = model.vEffective_Date_B_AFT == "NULL" ? new DateTime(1,1,1) : TypeTransfer.stringToDateTimeN(model.vEffective_Date_B_AFT);
                            _Marginp.EFFECTIVE_DATE_E_AFT = model.vEffective_Date_E_AFT == "NULL" ? new DateTime(1,1,1) : TypeTransfer.stringToDateTimeN(model.vEffective_Date_E_AFT);
        ...
        public Tuple<bool, string> CDCApproved(TreasuryDBEntities db, List<string> itemIDs, string logStr, DateTime dt)
        {
            foreach (var itemID in itemIDs)
            {
                ...
                {
                    _Marginp.INVENTORY_STATUS = "1"; //在庫
                    _Marginp.MARGIN_TAKE_OF_TYPE = GetNewValue(_Marginp.MARGIN_TAKE_OF_TYPE, _Marginp.MARGIN_TAKE_OF_TYPE_AFT);
                    _Marginp.MARGIN_TAKE_OF_TYPE_AFT = null;
                    _Marginp.TRAD_PARTNERS = GetNewValue(_Marginp.TRAD_PARTNERS, _Marginp.TRAD_PARTNERS_AFT);
                    _Marginp.TRAD_PARTNERS_AFT = null;
                    _Marginp.AMOUNT = string.IsNullOrEmpty(TypeTransfer.decimalNToString(_Marginp.AMOUNT_AFT)) ? _Marginp.AMOUNT : TypeTransfer.decimalNToDecimal(_Marginp.AMOUNT_AFT);
                    _Marginp.AMOUNT_AFT = null;
                    _Marginp.MARGIN_ITEM = GetNewValue(_Marginp.MARGIN_ITEM, _Marginp.MARGIN_ITEM_AFT);
                    _Marginp.MARGIN_ITEM_AFT = null;
                    _Marginp.MARGIN_ITEM_ISSUER = GetNewValue(_Marginp.MARGIN_ITEM_ISSUER, _Marginp.MARGIN_ITEM_ISSUER_AFT);
                    _Marginp.MARGIN_ITEM_ISSUER_AFT = null;
                    _Marginp.PLEDGE_ITEM_NO = GetNewValue(_Marginp.PLEDGE_ITEM_NO, _Marginp.PLEDGE_ITEM_NO_AFT);
                    _Marginp.PLEDGE_ITEM_NO_AFT = null;
                    _Marginp.EFFECTIVE_DATE_B =
                        _Marginp.EFFECTIVE_DATE_B_AFT == new DateTime(1, 1, 1) ? null :
                        string.IsNullOrEmpty(TypeTransfer.dateTimeNToString(_Marginp.EFFECTIVE_DATE_B_AFT)) ? _Marginp.EFFECTIVE_DATE_B : _Marginp.EFFECTIVE_DATE_B_AFT;
                    _Marginp.EFFECTIVE_DATE_B_AFT = null;
                    _Marginp.EFFECTIVE_DATE_E =
                        _Marginp.EFFECTIVE_DATE_E_AFT == new DateTime(1, 1, 1) ? null :
                        string.IsNullOrEmpty(TypeTransfer.dateTimeNToString(_Marginp.EFFECTIVE_DATE_E_AFT)) ? _Marginp.EFFECTIVE_DATE_E : _Marginp.EFFECTIVE_DATE_E_AFT;
                    _Marginp.EFFECTIVE_DATE_E_AFT = null;
                    _Marginp.DESCRIPTION = GetNewValue(_Marginp.DESCRIPTION, _Marginp.DESCRIPTION_AFT);
                    _Marginp.DESCRIPTION_AFT = null;
        ...
        public Tuple<bool, string> CDCChargeReject(TreasuryDBEntities db, List<string> itemIDs, string logStr, DateTime dt)
        {
            foreach (var itemID in itemIDs)
            {
                ...
                {
                    _Marginp.INVENTORY_STATUS = "1"; //在庫
                    _Marginp.CHARGE_DEPT_AFT = null;
                    _Marginp.CHARGE_SECT_AFT = null;
                    _Marginp.LAST_UPDATE_DT = dt;
                    logStr = _Marginp.modelToString(logStr);
                }
                else
        ...
        public Tuple<bool, string> CDCChargeApproved(TreasuryDBEntities db, List<string> itemIDs, string logStr, DateTime dt)
        {
            foreach (var itemID in itemIDs)
            {
                ...
                {
                    _Marginp.INVENTORY_STATUS = "1"; //在庫
                    _Marginp.CHARGE_DEPT = _Marginp.CHARGE_DEPT_AFT;
                    _Marginp.CHARGE_DEPT_AFT = null;
                    _Marginp.CHARGE_SECT = _Marginp.CHARGE_SECT_AFT;
                    _Marginp.CHARGE_SECT_AFT = null;
                    _Marginp.LAST_UPDATE_DT = dt;
                    logStr = _Marginp.modelToString(logStr);
                }
